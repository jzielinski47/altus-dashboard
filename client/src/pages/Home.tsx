...
import { gradientText } from "../components/tailwind-prefabs";
...
export default function Home() {
  return (
    ...
    >
      <div className="flex-1 flex flex-col gap-1 justify-center items-center lg:items-start">
        <h1 className="text-4xl sm:text-6xl font-bold text-balanced lg:text-pretty text-center lg:text-left tracking-tight ">
          Connect, Track, and Grow—All in One Place.
        </h1>
        <p
          className={
            gradientText +
            " text-lg text-pretty text-left font-medium mt-4 text-neutral-400 max-w-prose sm:text-xl/8"
          }
        >
